...
import 'pome_page_model.dart';
export 'pome_page_model.dart';

class PomePageWidget extends StatefulWidget {
  const PomePageWidget({Key? key}) : super(key: key);

  @override
  _PomePageWidgetState createState() => _PomePageWidgetState();
}

class _PomePageWidgetState extends State<PomePageWidget> {
  late PomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PomePageModel());
